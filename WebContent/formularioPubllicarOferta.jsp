...
<div id="columnaIzq">
  ...
  <body>
    ...
    <p class="letra1">Aqui la empresa podra publicar la oferta de trabajo con la cuenta</p>
    <p class="letra2"><span class="letras1"><a href="bienvenidaEmpresas.jsp">INICIO</a></span></p>
    <p>&nbsp;</p>

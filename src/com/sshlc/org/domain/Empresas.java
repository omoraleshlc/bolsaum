...
public class Empresas {
     ...
     * @return the keyEmp
     */
    public Integer getKeyEmp() {
        return keyEmp;
    }

    /**
     * @param keyEmp the keyEmp to set
     */
    public void setKeyEmp(Integer keyEmp) {
        this.keyEmp = keyEmp;
    }
    ...
    /**
     * @param descripcionSector the descripcionSector to set
     */
